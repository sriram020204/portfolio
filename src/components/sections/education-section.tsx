      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div>
          {portfolioData.education.map((edu, index) => (
            <Card 
              key={index} 
              className="shadow-lg mb-6 transition-all duration-300 ease-in-out hover:shadow-xl hover:scale-[1.07] hover:-translate-y-1 animate-fade-in-up max-w-4xl mx-auto"
